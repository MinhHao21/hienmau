    ...
    public function fileupload(Request $request)
    {
        ...
        foreach ($file as $fl) {
            ...
            if ($duoifile == 'docx' || $duoifile == 'xlsx' || $duoifile == 'doc' || $duoifile == 'xls') {
                $linkview  = 'https://view.officeapps.live.com/op/view.aspx?src=http://locha.hatinh.gov.vn/' . $linkfile . '/' . $name . '&amp;wdStartOn=1';
            } else if ($duoifile == 'pdf' || $duoifile == 'PDF') {
                $linkview = 'http://locha.hatinh.gov.vn/' . $linkfile . '/' . $name;
            } else {
                $linkview = '';
            }
